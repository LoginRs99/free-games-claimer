  ...
  },
  {
    ...
    configFields: [
      { key: 'presenceMinutes', env: 'AWA_PRESENCE_MINUTES', type: 'number', default: 25,
        ...
        unit: 'minutes',
        hint: 'Time on Site presence. The script automatically skips presence once the daily Time on Site ARP cap is reached (e.g. 5/5 ARP). Set to 0 to disable.',
      ...
      { key: 'twitchStreamers', env: 'AWA_TWITCH_STREAMERS', type: 'string',
        default: 'matthewsantoro,trishahershberger,mactics,hazeleyedchic,kesslive,3llebelle,thegeekentry,lovinurstyle,layria',
        label: 'Fallback / manual Twitch streamers',
        hint: 'Comma-separated Twitch usernames used as fallback or when manual mode is selected.' },
